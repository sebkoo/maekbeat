...
| Hazard rows a build can check               | [docs/regulatory](docs/regulatory) — each row cites its test, `scripts/check-hazard-tests.sh` fails when one stops resolving | C20 ✅ · C21 (planned)          |
...
| Tooling choices and trade-offs              | [docs/DECISIONS.md](docs/DECISIONS.md) (28 entries today)                                                                    | C0 ✅                           |
...
| 7 — Depth                | intended use, hazard analysis, risk register, threat model, SBOM                                                                              | ⬜     | C20 hazard analysis + its guard · C21–C22 still to come                                                                                                                                                                                                                                                                                                                                                 |
