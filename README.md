...
| 6 — Infra & operations   | OTel tracing (C18), Docker + compose, k6 load rig, AWS CDK stack                                                                              | ⬜     | C18 tracing · C19 image + compose + k6 + CDK stack (synthesized and asserted, never deployed) · CI image build, registry publish and dashboards-as-code still to come                                                                                                                                                                                                                                                                                                        |
