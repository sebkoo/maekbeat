...
| Tooling choices and trade-offs           | [docs/DECISIONS.md](docs/DECISIONS.md) (15 entries today)                     | C0 ✅                  |
...
apps/        server (WS ingest · ring buffer · alert engine · REST reads · fan-out · decisions — C5–C12)
             web (tokens · live chart · timeline · acknowledgement · WCAG 2.2 AA · e2e smoke — C10–C13) · ios — planned, C14–C17
