...
| 7 — Depth                | intended use, hazard analysis, risk register, silence alarm, threat model, SBOM                                                               | ⬜     | [C20 hazard analysis + its guard](https://github.com/sebkoo/maekbeat/commit/4b76c8b) · [C20a the alarm that analysis found missing](https://github.com/sebkoo/maekbeat/commit/bccd59e) · C21–C22 still to come                                                                                                                                                                                          |
