...
| 6 — Infra & operations   | OTel tracing (C18), Docker + compose, k6 load rig, AWS CDK stack                                                                              | ⬜     | [C18 tracing](https://github.com/sebkoo/maekbeat/commit/3260723) · [C19 container, load rig, AWS stack](https://github.com/sebkoo/maekbeat/compare/3260723...11c9adf) · [C19 delivery pipeline](https://github.com/sebkoo/maekbeat/compare/bccd59e...38ad125) · dashboards-as-code still to come                                                                                                        |
