...
The scenario shapes below are plausibility heuristics for a demo, not clinical models. They exist so the alert engine (shipped — C7) and the dashboard (shipped — C10–C11) receive signal shaped like a wearable's output; no diagnostic claim is made anywhere in this repo (see [DISCLAIMER.md](../../DISCLAIMER.md)).
